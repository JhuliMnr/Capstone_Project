...
# import pandas as pd
#
# file = 'C:/Users/HP/Desktop/Geology of Ecuador/BB4/BB4_2015-03/8E.BB4.HHZ.20150307.mseed'
# st = read(file)
# st.detrend(type='demean')
# st.detrend(type='linear')
# st.taper(type="cosine", max_percentage=0.05)
...
#     p_amp.append(pamp)
#     # Compute the FFT
#     fft_signal = rfft(edata)
#     freqs = rfftfreq(len(edata)) * sr  # Real Frequency --> Real numbers
#     # Calculate the peak frequency
#     peak_freq = freqs[np.argmax(np.abs(fft_signal))]
#     max_freq.append(peak_freq)
#     # Calculate the center frequency and frequency index
...
# df9 = pd.DataFrame(list(zip(*[FI])), columns=['Frequency_Index'])
# df = pd.concat([dfton, dftof, df1, df2, df3, df4, df5, df6, df7, df8, df9], axis=1)
# df.to_csv('C:/Users/HP/Desktop/Geology of Ecuador/8E.BB4.HHZ.20150307_newversion.csv')
#
# end = timer()
# print(timedelta(seconds=end - start))